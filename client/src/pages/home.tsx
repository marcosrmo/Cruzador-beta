...
import { Download, Loader2, CheckCircle, Smartphone, Instagram, Wrench, Settings, LogOut } from "lucide-react";
    ...
    <div className="min-h-screen bg-transparent py-12 px-4 sm:px-6 lg:px-8 font-sans relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto space-y-10 relative z-10">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-lg text-green-400 max-w-2xl mx-auto font-medium">
